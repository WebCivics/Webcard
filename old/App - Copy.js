    ...
    <div className="bg-gray-800 text-white min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-10">
          ...
          <p className="text-gray-400 mt-2 text-lg">View and create Agent Discovery Protocol profiles. For More information, including details about efforts to advance this technologies design and implementation via IETF (See <a href="https://mediaprophet.github.io/init-draft-standards-wip/ADP/draft-webcivics-adp-protocol-01.txt" className="text-blue-400 hover:underline" target="_blank" rel="noreferrer">Draft ID</a>) & W3C (see <a href="https://mediaprophet.github.io/init-draft-standards-wip/ADP/" className="text-blue-400 hover:underline" target="_blank" rel="noreferrer">Draft respec doc</a>), please refer to the documentation available on <a href="https://github.com/WebCivics/Webcard" className="text-blue-400 hover:underline" target="_blank" rel="noreferrer">the documentation available on GitHub</a>, which includes information about how to use the WebCard Utility as an API.</p>
        </header>
        ...
        <footer className="text-center mt-12 text-gray-500 text-sm">
          <div>
            Developed by <a href="https://webcivics.github.io/Webcard/?domain=sailingdigital.com" className="text-blue-400 hover:underline">Timothy Holborn</a>, in React with the assistance of{' '}
            <a href="https://x.ai/grok" className="text-blue-400 hover:underline" target="_blank" rel="noreferrer">xAI Grok 3</a> and{' '}
            <a href="https://deepmind.google/technologies/gemini/" className="text-blue-400 hover:underline" target="_blank" rel="noreferrer">Google Gemini 2.5 Pro</a>.
          </div>
          <div className="mt-2">
            Source code available at{' '}
            <a href="https://github.com/WebCivics/Webcard/" className="text-blue-400 hover:underline" target="_blank" rel="noreferrer">GitHub</a>.
          </div>
        </footer>
      </div>
    </div>
